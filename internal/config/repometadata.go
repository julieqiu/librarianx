...
func GenerateRepoMetadata(library *Library, language, repo, serviceConfigPath, outdir, apiPath string) error {
	...
	// Extract version from API path (e.g., "google/cloud/secretmanager/v1" -> "v1")
	defaultVersion := DeriveDefaultVersion(apiPath)
